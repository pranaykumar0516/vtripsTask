...
class MaterialUIPickersDatePicker extends React.Component {
  state = {
...
class MaterialUIPickersTimePicker extends React.Component {
  state = {
    // The first commit of Material-UI
    selectedDate: new Date("2014-08-18T21:11:54")
  };
...
class MaterialUIPickersDateAndTimePicker extends React.Component {
  state = {
    // The first commit of Material-UI
    selectedDate: new Date("2014-08-18T21:11:54")
  };
